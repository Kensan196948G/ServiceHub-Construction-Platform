...
@router.get("/projects/{project_id}/daily-reports", response_model=PaginatedResponse[DailyReportResponse])
...
@router.post("/projects/{project_id}/daily-reports",
             response_model=ApiResponse[DailyReportResponse], status_code=status.HTTP_201_CREATED)
...
@router.get("/daily-reports/{report_id}", response_model=ApiResponse[DailyReportResponse])
...
@router.put("/daily-reports/{report_id}", response_model=ApiResponse[DailyReportResponse])
