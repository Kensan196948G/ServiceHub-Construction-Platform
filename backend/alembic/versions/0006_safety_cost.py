...
down_revision: str | None = "0005_photos"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "overall_result", sa.String(10), nullable=False, server_default="PENDING"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "budgeted_amount", sa.Numeric(15, 0), nullable=False, server_default="0"
        ),
        sa.Column(
            "actual_amount", sa.Numeric(15, 0), nullable=False, server_default="0"
        ),
